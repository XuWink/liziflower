export const enum apiList {
    ...
    changeNumber = "/cart/change-number", //更新购物车中的单个商品的数量
    getAllNotices = "/notice/all-notices", //获取所有评论
    getNoticeDetail = "/notice/get-notice-by-id?noticeid=",//根据公告id获取公告详情
    ...
    deleteItemsPaid = "/order/delete-items-paid", //删除待支付订单
    ...
    getFlowerLanguage = "/flower/get-flower-language", //获取花语
    getOneLanguage = "/flower/get-one-language?find=", //查询一条花语
    updateMoney = "/consumer/updatemoney?userid=",//充值
}
